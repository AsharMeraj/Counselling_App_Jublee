    ...
    <div className="min-h-[calc(100vh-6rem)] bg-primary/5 pb-24">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full px-3 sm:px-6 text-center">
          ...
          These tools are clinically validated for accurate screening.
          </p>
        </div>
      </div>

      {/* Main Content Grid: Card design with theme-specific colors */}
      <div className="max-w-6xl mx-auto px-3 sm:px-6 mt-10 relative z-20">
        <div className="flex flex-wrap justify-center gap-8">
           <div
                onClick={() => router.push(`/normalScreening`)}
                className="group relative bg-white rounded-[2.5rem] p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-slate-100 cursor-pointer transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] hover:-translate-y-2 max-w-sm w-full"
              >
                {/* Card Top Section */}
                <div className="mb-6">
