        ...
        <div className="min-h-[calc(100vh-6rem)] bg-primary/5 pb-24">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-3 sm:px-6 text-center">
              <div className="bg-white/20 backdrop-blur-md px-4 py-1 sm:py-1.5 rounded-full text-white text-[10px] lg:text-[14px] sm:text-[12px] font-black uppercase tracking-[0.3em] mb-2 sm:mb-4 border border-white/30">
