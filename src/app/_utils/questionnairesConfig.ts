...
> = {
  ...
  "DASS-10": {
    maxScore: 30,
    scoreRanges: [
      { min: 0, max: 7, classification: "Normal", color: "text-green-500" },
      { min: 8, max: 12, classification: "Mild distress", color: "text-yellow-500" },
      { min: 13, max: 20, classification: "Moderate distress", color: "text-orange-500" },
      { min: 21, max: 30, classification: "Severe distress", color: "text-red-500" }
    ]
  },
};