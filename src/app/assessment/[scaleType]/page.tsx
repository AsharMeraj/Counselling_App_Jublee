...
const DynamicAssessmentForm = ({ params }: { params: Promise<{ scaleType: string }> }) => {
    ...
    // Dynamically pick the question set from mapping
    ...
    return (
        <div className="min-h-screen bg-primary/5 pb-20 overflow-x-hidden">
            ...
            {/* Hero Section with Gradient Background and Wave Embroidery */}
            <div
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 -mt-16 relative z-30">
                ...
                {/* Main Content Card */}
                <div className="bg-white rounded-[2.5rem]  shadow-2xl shadow-blue-900/5 border border-slate-100 p-8 sm:p-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="space-y-16">
                        {currentQuestions.map((q, i) => (
                            <div key={i} className="space-y-6">
                                <div className={cn(
                                    ...
                                    <p className={cn(
                                        "text-xl sm:text-xl font-bold text-primary",
                        ...
                        <div className="pt-8 border-t border-slate-100">
                            ...
                            <p className="text-center text-slate-400 text-xs mt-6 font-semibold uppercase tracking-widest">
                                {isUrdu ? "آپ کی رازداری ہماری ترجیح ہے" : "Your privacy is our priority"}
                            </p>
                        </div>
                    </div>
                </div>
